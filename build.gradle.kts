...
subprojects {
    ...
    aliucord {
        ...
        updateUrl.set("https://raw.githubusercontent.com/DavidNyan10/AlliucordPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/DavidNyan10/AlliucordPlugins/builds/%s.zip")
    }
